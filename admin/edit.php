		...
		if($imgFile != ''){
			...
			if(in_array($imgExt,$valid_ext)){
				if($imgSize < 5000000){
					...
					if (file_exists("photos/" . $imgOld)) {
						unlink("photos/" . $imgOld);
					}
...
<html>
	...
	<div class="container">
			<div class="header">
				...
				<a href="viewrecords.php">View Records</a> | <a href="adduser.php">Add User Account</a><br><br>
			</div>
				...
				<form action="" method="post" enctype="multipart/form-data" onsubmit="return validatePassword()">
					<table>
						...
						<tr>
							...
							<img src="photos/<?php echo $picture;?>" width="100" height="100"></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
