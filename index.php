...
<div class="header">
        ...
        <div class="header-buttons">
            ...
            <a href="customer/cart.php"><button class="cart-btn">My Cart</button></a>
            <?php if(isset($_SESSION['cid'])): ?>
                <div class="user-dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="customer/edit.php">Account Settings</a>
                        <a href="customer/viewpurchase.php">View Purchase</a>
    ...
    <div class="container">
        <div class="products">
            ...
            <div class="product">
                ...
                <a href="customer/cart.php"><button>Add to Cart</button></a>
            </div>
            <?php
                }
            } else {
